...
# # CAREER SERVICE — SUPMTI
# # Career Simulation (4.8)
# # VERSION CORRIGÉE — 7 filières officielles (IISI, MGE, MDI, FACG, MRI, IISIC, IISRT)
# # ============================================================
...
#         ],
#         "entreprises_maroc": [
#             "OCP Export", "Maroc Export",
#             "Sociétés d'import-export",
#             "Agences de commerce international",
#             "Multinationales au Maroc"
#         ],
#         "salaire_depart": "4000-7000 MAD/mois",
#         "salaire_3ans": "7000-12000 MAD/mois",
#         "salaire_7ans": "12000-22000 MAD/mois",
...
#         "certifications_utiles": [
#             "Incoterms ICC",
#             "Certification Commerce International",
#             "PMP (Project Management)",
#             "Langues (TOEIC, DELE, etc.)"
#         ],
#         "poursuite_possible": ["MRI", "FACG", "Master Commerce International"]
#     },
...
#         ],
#         "entreprises_maroc": [
#             "Ministères marocains", "Ambassades",
#             "OCP International", "RAM Maroc",
#             "ONG internationales", "Organisations multilatérales"
#         ],
#         "salaire_depart": "7000-12000 MAD/mois",
#         "salaire_3ans": "12000-20000 MAD/mois",
#         "salaire_7ans": "20000-38000 MAD/mois",
...
#             "Conseiller diplomatique d'entreprise",
#             "Directeur général filiale internationale",
#             "Consultant international senior",
#             "Fonctionnaire international"
#         ],
#         "certifications_utiles": [
#             "Langues (TOEIC, DALF, DELE)",
#             "Certification Diplomatie d'entreprise",
#             "PMP (Project Management)",
#             "Certification Relations Internationales"
#         ],
#         "poursuite_possible": ["Master Relations Internationales France", "MBA International"]
#     },
# }
...
# def generer_progression_salariale(filiere_id):
#     """Retourne les données de progression salariale"""
#     carriere = CARRIERES_FILIERES.get(filiere_id, {})

#     def extraire_milieu(fourchette):
#         try:
#             parties = fourchette.replace(" MAD/mois", "").replace(" EUR/mois", "").split("-")
#             return (int(parties[0]) + int(parties[1])) // 2
#         except:
#             return 0
...
#         "progression": [
#             {
#                 "periode": "Départ", "annee": 0,
#                 "fourchette":    carriere.get("salaire_depart", "N/A"),
#                 "valeur_mediane": extraire_milieu(carriere.get("salaire_depart", "0-0"))
#             },
#             {
#                 "periode": "Après 3 ans", "annee": 3,
#                 "fourchette":    carriere.get("salaire_3ans", "N/A"),
#                 "valeur_mediane": extraire_milieu(carriere.get("salaire_3ans", "0-0"))
#             },
#             {
#                 "periode": "Après 7 ans", "annee": 7,
#                 "fourchette":    carriere.get("salaire_7ans", "N/A"),
#                 "valeur_mediane": extraire_milieu(carriere.get("salaire_7ans", "0-0"))
#             }
#         ],
...
#     Logique SUPMTI :
#     Ingénierie  : Terminal → IISI (BAC+3) → IISIC ou IISRT (BAC+5)
#     Management  : Terminal → MGE ou MDI (BAC+3) → FACG ou MRI (BAC+5)
#     """
#     parcours = profil_etudiant.get("parcours_academique", {})
#     niveau   = parcours.get("niveau_actuel", "post_bac")
#     diplome  = parcours.get("diplome_actuel", "") or ""
...
#             "explication": (
#                 "En tant que bachelier, tu intègres la 1ère année de SUPMTI. "
#                 "Trois portes d'entrée : IISI (Ingénierie), MGE ou MDI (Management). "
#                 "Les BAC+5 se préparent après le BAC+3 ou via admission parallèle."
#             ),
#             "note": (
#                 "IISI mène naturellement vers IISIC ou IISRT. "
#                 "MGE et MDI mènent naturellement vers FACG ou MRI."
#             ),
#             "annee_entree": "1ère année"
#         }
...
#         d in diplome.upper() for d in ["DUT", "BTS", "DEUG", "TS"]
#     ):
#         # Diplôme technique → ingénierie
#         if any(d in diplome.upper() for d in ["INFO", "INFORMATIQUE", "RESEAU", "TELECOM", "ELECTRONIQUE"]):
#             return {
#                 "filieres_accessibles": ["IISI", "IISIC", "IISRT"],
#                 "explication": (
#                     "Avec ton diplôme BAC+2 technique, tu peux intégrer SUPMTI "
#                     "en 3ème année — département Ingénierie."
#                 ),
#                 "note": "Étude de dossier et entretien requis.",
#                 "annee_entree": "3ème année"
#             }
#         # Diplôme gestion → management
#         else:
#             return {
#                 "filieres_accessibles": ["MGE", "MDI", "FACG", "MRI"],
#                 "explication": (
#                     "Avec ton diplôme BAC+2 en gestion, tu peux intégrer SUPMTI "
#                     "en 3ème année — département Management."
#                 ),
#                 "note": "Étude de dossier et entretien requis.",
#                 "annee_entree": "3ème année"
#             }

#     # ── BAC+3 : Licence, IISI SUPMTI, MGE/MDI SUPMTI ──
#     elif niveau == "bac3" or any(
#         d in diplome.upper() for d in ["LICENCE", "LICENSE", "BAC+3", "BAC 3"]
#     ):
#         # BAC+3 IISI SUPMTI → IISIC ou IISRT
#         if "IISI" in diplome.upper() or "ISI" in diplome.upper():
#             return {
#                 "filieres_accessibles": ["IISIC", "IISRT"],
#                 "explication": (
#                     "Avec ton BAC+3 IISI de SUPMTI, tu continues "
#                     "naturellement en 4ème année de IISIC ou IISRT."
#                 ),
...
#         # BAC+3 MGE ou MDI SUPMTI → FACG ou MRI
#         elif any(d in diplome.upper() for d in ["MGE", "MDI", "MANAGEMENT"]):
#             return {
#                 "filieres_accessibles": ["FACG", "MRI"],
#                 "explication": (
#                     "Avec ton BAC+3 en Management de SUPMTI, tu continues "
#                     "naturellement en 4ème année de FACG ou MRI."
#                 ),
#                 "note": "FACG → Finance et Audit. MRI → Relations Internationales.",
#                 "annee_entree": "4ème année"
#             }

#         # Licence Informatique → Ingénierie BAC+5
#         elif any(d in diplome.upper() for d in ["INFO", "INFORMATIQUE", "RESEAU", "TELECOM"]):
#             return {
#                 "filieres_accessibles": ["IISIC", "IISRT"],
#                 "explication": (
#                     "Avec ta Licence en informatique/réseaux, "
#                     "tu intègres SUPMTI en 4ème année ingénierie."
#                 ),
#                 "note": "IISIC → IA, Data Science. IISRT → Réseaux intelligents, Télécommunications.",
#                 "annee_entree": "4ème année"
#             }

#         # Licence Gestion/Économie → Management BAC+5
#         elif any(
#             d in diplome.upper()
#             for d in ["GESTION", "ECONOMIE", "COMMERCE", "FINANCE", "COMPTABILITE", "INTERNATIONAL"]
#         ):
#             return {
#                 "filieres_accessibles": ["FACG", "MRI"],
#                 "explication": (
...
#                     "tu intègres SUPMTI en 4ème année management."
#                 ),
#                 "note": "FACG → Finance, Audit. MRI → Relations Internationales.",
#                 "annee_entree": "4ème année"
#             }
...
#                     "BAC+5 de SUPMTI en 4ème année."
#                 ),
#                 "note": "Ingénierie : IISIC ou IISRT. Management : FACG ou MRI.",
#                 "annee_entree": "4ème année"
#             }
...
#             "filieres_accessibles": ["IISI", "MGE", "MDI"],
#             "explication": "Tu peux intégrer la 1ère année de SUPMTI.",
#             "note": "IISI (Ingénierie), MGE ou MDI (Management).",
#             "annee_entree": "1ère année"
#         }
...
# CAREER SERVICE — SUPMTI
# Career Simulation (4.8)
# VERSION FINALE — 7 filières officielles
# (IISI, MGE, MDI, FACG, MRI, IISIC, IISRT)
# ============================================================
...
CARRIERES_FILIERES = {
    ...
    "IISI": {
        ...
        "taux_insertion":         "85%",
        "possibilites_evolution": [
            "Chef de projet IT", "Architecte logiciel",
            "CTO d'une startup", "Consultant IT", "Entrepreneuriat tech"
        ],
        "certifications_utiles": [
    ...
    "IISRT": {
        ...
        "entreprises_maroc": [
            "Maroc Telecom", "Inwi", "Orange Maroc",
            "Huawei Maroc", "Nokia Maroc", "ONEE", "RAM Maroc"
        ],
        "salaire_depart":         "7000-12000 MAD/mois",
        "salaire_3ans":           "12000-20000 MAD/mois",
        "salaire_7ans":           "20000-38000 MAD/mois",
        ...
        "taux_insertion":         "90%",
        "possibilites_evolution": [
            "Directeur infrastructure", "Expert sécurité réseau",
            "Consultant télécom", "Ingénieur cloud", "Responsable IoT"
        ],
        "certifications_utiles": [
    ...
    "IISIC": {
        ...
        "taux_insertion":         "92%",
        "possibilites_evolution": [
            "Lead Data Scientist", "Directeur IA",
            "CTO / fondateur startup IA", "Chercheur en IA", "Consultant international"
        ],
        "certifications_utiles": [
    ...
    "MGE": {
        ...
        "possibilites_evolution": [
            ...
            "DRH", "Directeur général PME", "Entrepreneur"
        ],
        "certifications_utiles": [
...
GÉNÈRE une simulation narrative avec ce FORMAT EXACT :
...
def obtenir_filieres_comparables(profil_etudiant):
    ...
    - Post-BAC / BAC+1 → IISI, MGE, MDI (BAC+3 uniquement)
    - BAC+2 (DUT/BTS) → IISI, MGE ou MDI selon spécialité (BAC+3 uniquement)
    - BAC+3 IISI/SUPMTI ou Licence info → IISIC ou IISRT (BAC+5)
    - BAC+3 MGE/MDI/SUPMTI ou Licence gestion → FACG ou MRI (BAC+5)
    ...
    if niveau == "post_bac":
        ...
        return {
            ...
            "explication": (
                "Avec ton diplôme BAC+2, tu intègres SUPMTI en 3ème année. "
                "Les filières BAC+5 (IISIC, IISRT, FACG, MRI) sont accessibles "
                "après validation du BAC+3."
            ),
            "note": note,
            "annee_entree": "3ème année"
        }
        ...
        if any(d in diplome for d in ["IISI", "ISI", "INGENIERIE DES SYSTEMES",
            ...
            return {
                "filieres_accessibles": ["IISIC", "IISRT"],
                "explication": "Avec ton BAC+3 IISI (SUPMTI), tu continues en 4ème année IISIC ou IISRT.",
                "note": "IISIC → IA et Data Science. IISRT → Réseaux et Télécommunications.",
                "annee_entree": "4ème année"
            }
            ...
            return {
                "filieres_accessibles": ["FACG", "MRI"],
                "explication": "Avec ton BAC+3 MGE (SUPMTI), tu continues en 4ème année FACG ou MRI.",
            ...
            return {
                ...
                "explication": "Avec ton BAC+3 MDI (SUPMTI), tu continues en 4ème année MRI ou FACG.",
            ...
            "CYBER", "SECURITE", "TECH", "INGENIERIE", "ELECTRONI", "NUMERIQUE",
            "WEB", "DEV", "DEVELOPPEMENT", "MOBILE", "CLOUD", "DATA", "IA",
            "INTELLIGENCE", "MACHINE", "LEARNING", "LOGICIEL", "SOFTWARE",
            "APPLI", "PROGRAMMATION", "DIGITAL", "CODE", "PYTHON", "JAVA",
            "SQL", "LINUX", "IOT"]):
            return {
                "filieres_accessibles": ["IISIC", "IISRT"],
                "explication": "Avec ta Licence en informatique/réseaux, tu intègres SUPMTI en 4ème année ingénierie.",
            ...
            return {
                "filieres_accessibles": ["FACG", "MRI"],
                "explication": "Avec ta Licence en gestion/économie, tu intègres SUPMTI en 4ème année management.",
            ...
            return {
                "filieres_accessibles": ["IISIC", "IISRT", "FACG", "MRI"],
                "explication": "Avec un BAC+3, tu peux intégrer les filières BAC+5 de SUPMTI en 4ème année.",
                "note": "Ingénierie : IISIC ou IISRT. Management : FACG ou MRI.",
                "annee_entree": "4ème année"
            }
...
def comparer_carrieres_intelligent(
    ...
    """Version intelligente du comparateur — vérifie l'accessibilité par niveau."""
    info_filieres        = obtenir_filieres_comparables(profil_etudiant)
    filieres_accessibles = info_filieres["filieres_accessibles"]
