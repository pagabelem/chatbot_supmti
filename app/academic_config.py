...
#     "SMA":            {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 5, "IISIC": 5, "IISRT": 5},
#     "SMB":            {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 5, "IISIC": 5, "IISRT": 5},
#     "SP":             {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 4, "IISIC": 4, "IISRT": 5},
#     "SVT":            {"IISI": 4, "FACG": 3, "MSTIC": 3, "IISI": 3, "IISIC": 2, "IISRT": 2},
#     "STE":            {"IISI": 2, "FACG": 1, "MSTIC": 2, "IISI": 4, "IISIC": 4, "IISRT": 5},
#     "STM":            {"IISI": 2, "FACG": 1, "MSTIC": 2, "IISI": 4, "IISIC": 3, "IISRT": 4},
#     "STGC":           {"IISI": 5, "FACG": 5, "MSTIC": 4, "IISI": 2, "IISIC": 2, "IISRT": 1},
#     "SEG":            {"IISI": 5, "FACG": 5, "MSTIC": 4, "IISI": 2, "IISIC": 2, "IISRT": 1},
#     "SGC":            {"IISI": 5, "FACG": 5, "MSTIC": 4, "IISI": 2, "IISIC": 2, "IISRT": 1},
#     "LSH":            {"IISI": 3, "FACG": 2, "MSTIC": 2, "IISI": 1, "IISIC": 1, "IISRT": 1},
#     "S":              {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 4, "IISIC": 4, "IISRT": 5},
#     "SM":             {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 5, "IISIC": 5, "IISRT": 5},
#     "D":              {"IISI": 4, "FACG": 3, "MSTIC": 3, "IISI": 3, "IISIC": 2, "IISRT": 2},
#     "E":              {"IISI": 2, "FACG": 1, "MSTIC": 2, "IISI": 4, "IISIC": 4, "IISRT": 5},
#     "C":              {"IISI": 5, "FACG": 5, "MSTIC": 4, "IISI": 2, "IISIC": 2, "IISRT": 1},
#     "L":              {"IISI": 3, "FACG": 2, "MSTIC": 2, "IISI": 1, "IISIC": 1, "IISRT": 1},
#     "A":              {"IISI": 3, "FACG": 2, "MSTIC": 2, "IISI": 1, "IISIC": 1, "IISRT": 1},
#     "BAC_GENERAL_FR": {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 4, "IISIC": 4, "IISRT": 4},
#     "AUTRE":          {"IISI": 3, "FACG": 3, "MSTIC": 3, "IISI": 3, "IISIC": 3, "IISRT": 3}
# }
...
#             "IISI": ["DUT Informatique", "BTS Informatique", "DEUG Informatique", "DUT Réseaux", "Licence 2 Informatique"],
...
#             "IISI": ["BTS Gestion", "DUT GEA", "DEUG Économie", "Licence 2 Gestion"],
...
#         "filieres_compatibles": {
#             "IISIC": ["Licence Informatique", "BAC+3 IISI SUPMTI", "Licence Réseaux"],
#             "IISRT": ["Licence Informatique", "BAC+3 IISI SUPMTI", "Licence Réseaux", "Licence Télécoms"],
#             "FACG": ["Licence Gestion", "Licence Économie", "BAC+3 IISI SUPMTI", "Licence Comptabilité"],
#             "MSTIC": ["Licence Informatique", "Licence Management", "BAC+3 IISI SUPMTI", "BAC+3 IISI SUPMTI"]
#         },
#         "moyenne_min": 12,
#         "procedure": "Étude de dossier + entretien"
#     }
...
# ============================================================
# FICHIER DE CONFIGURATION ACADÉMIQUE — SUPMTI MEKNÈS
# VERSION CORRIGÉE — 7 filières officielles
# ============================================================
...
BOURSES = {
    "description": "Bourses basées sur les résultats du concours d'admission",
    "paliers": [
        {"note_min": 18,   "note_max": 20,    "pourcentage": 100, "label": "Bourse Excellence Totale",  "reduction": 35000, "a_payer": 3500  },
        {"note_min": 16,   "note_max": 17.99, "pourcentage": 70,  "label": "Bourse Excellence",         "reduction": 24500, "a_payer": 14000 },
        {"note_min": 14,   "note_max": 15.99, "pourcentage": 50,  "label": "Bourse Mérite",              "reduction": 17500, "a_payer": 21000 },
        {"note_min": 12,   "note_max": 13.99, "pourcentage": 30,  "label": "Bourse Encouragement",      "reduction": 10500, "a_payer": 28000 },
        {"note_min": 0,    "note_max": 11.99, "pourcentage": 0,   "label": "Pas de bourse",              "reduction": 0,     "a_payer": 38500 },
    ],
    "note": "La bourse s'applique uniquement sur les frais de scolarité (35000 MAD). Les frais d'inscription (3500 MAD) restent fixes."
}

# ============================================================
# 4. LES 7 FILIÈRES OFFICIELLES DE SUPMTI
# ============================================================
...
FILIERES = {
    ...
    "MDI": {
        ...
        "departement": "Management",
        "duree": 3,
        "description": "Formation orientée vers le commerce international, le développement des marchés à l'export, et les relations d'affaires interculturelles.",
        "competences_cles": [
            "Commerce international",
            "Marketing international",
            "Gestion des opérations import-export",
            "Langues des affaires (arabe, français, anglais, espagnol)",
    ...
    "MRI": {
        ...
        "departement": "Management",
        "duree": 2,
        "description": "Formation de cadres capables de piloter les relations institutionnelles, commerciales et diplomatiques à l'international, avec maîtrise de plusieurs langues et cultures.",
        "competences_cles": [
            "Diplomatie d'entreprise",
            "Stratégie internationale",
            "Gestion des partenariats institutionnels",
            "Communication interculturelle avancée",
            "Maîtrise de trois langues minimum"
        ],
        "debouches": [
        ...
        "poursuite_etudes": [],
        "difficulte": 3,
        "orientation_dominante": "relations_internationales",
        "taux_insertion": "88%"
    },
}
...
TYPES_BAC = {
    ...
    "SMA": {
        ...
        "matieres_principales": ["Mathématiques", "Physique-Chimie"],
        "matieres_secondaires": ["SVT", "Philosophie", "Français", "Anglais"],
        "force_maths": 5, "force_physique": 4, "force_info": 2,
    ...
    "SEG": {
        "pays": "Maroc", "label": "Sciences Économiques et Gestion", "type": "economique",
        "matieres_principales": ["Économie", "Mathématiques", "Comptabilité"],
        "matieres_secondaires": ["Droit", "Français", "Anglais"],
        "force_maths": 3, "force_physique": 1, "force_info": 1,
    ...
    "SGC": {
        "pays": "Maroc", "label": "Sciences de Gestion Comptable", "type": "gestion",
        "matieres_principales": ["Comptabilité", "Mathématiques", "Économie"],
        "matieres_secondaires": ["Droit", "Français", "Anglais"],
        "force_maths": 3, "force_physique": 1, "force_info": 1,
        "force_economie": 4, "force_gestion": 5, "force_langues": 2
    ...
    "SM": {
        "pays": "Afrique Subsaharienne", "label": "BAC SM — Sciences et Mathématiques", "type": "scientifique",
        "matieres_principales": ["Mathématiques", "Physique-Chimie"],
        "matieres_secondaires": ["SVT", "Philosophie", "Français", "Anglais"],
        "force_maths": 5, "force_physique": 4, "force_info": 2,
        "force_economie": 1, "force_gestion": 1, "force_langues": 3
    ...
    "C": {
        "pays": "Afrique Subsaharienne", "label": "BAC C — Sciences Économiques et Mathématiques", "type": "economique",
        "matieres_principales": ["Mathématiques", "Économie", "Comptabilité"],
        "matieres_secondaires": ["Droit", "Français", "Anglais"],
        "force_maths": 3, "force_physique": 1, "force_info": 1,
    ...
    "L": {
        "pays": "Afrique Subsaharienne", "label": "BAC L — Lettres et Sciences Humaines", "type": "litteraire",
        "matieres_principales": ["Philosophie", "Langues", "Histoire-Géographie"],
        "matieres_secondaires": ["Mathématiques basiques"],
        "force_maths": 1, "force_physique": 1, "force_info": 1,
        "force_economie": 2, "force_gestion": 1, "force_langues": 5
    ...
    "A": {
        "pays": "Afrique Subsaharienne", "label": "BAC A — Lettres et Arts", "type": "litteraire",
        "matieres_principales": ["Langues", "Philosophie", "Arts"],
        "matieres_secondaires": ["Histoire", "Mathématiques basiques"],
        "force_maths": 1, "force_physique": 1, "force_info": 1,
        "force_economie": 2, "force_gestion": 1, "force_langues": 5
...
COMPATIBILITE_BAC_FILIERE = {
    "SMA":            {"IISI": 5, "IISIC": 5, "IISRT": 5, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 2},
    "SMB":            {"IISI": 5, "IISIC": 5, "IISRT": 5, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 2},
    "SP":             {"IISI": 4, "IISIC": 4, "IISRT": 5, "MGE": 3, "MDI": 2, "FACG": 3, "MRI": 2},
    "SVT":            {"IISI": 3, "IISIC": 2, "IISRT": 2, "MGE": 4, "MDI": 3, "FACG": 3, "MRI": 2},
    "STE":            {"IISI": 4, "IISIC": 4, "IISRT": 5, "MGE": 2, "MDI": 2, "FACG": 1, "MRI": 1},
    "STM":            {"IISI": 4, "IISIC": 3, "IISRT": 4, "MGE": 2, "MDI": 2, "FACG": 1, "MRI": 1},
    "STGC":           {"IISI": 2, "IISIC": 2, "IISRT": 1, "MGE": 5, "MDI": 4, "FACG": 5, "MRI": 3},
    "SEG":            {"IISI": 2, "IISIC": 2, "IISRT": 1, "MGE": 5, "MDI": 4, "FACG": 5, "MRI": 3},
    "SGC":            {"IISI": 2, "IISIC": 2, "IISRT": 1, "MGE": 5, "MDI": 4, "FACG": 5, "MRI": 3},
    "LSH":            {"IISI": 1, "IISIC": 1, "IISRT": 1, "MGE": 3, "MDI": 4, "FACG": 2, "MRI": 4},
    "S":              {"IISI": 4, "IISIC": 4, "IISRT": 5, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 2},
    "SM":             {"IISI": 5, "IISIC": 5, "IISRT": 5, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 2},
    "D":              {"IISI": 3, "IISIC": 2, "IISRT": 2, "MGE": 4, "MDI": 3, "FACG": 3, "MRI": 2},
    "E":              {"IISI": 4, "IISIC": 4, "IISRT": 5, "MGE": 2, "MDI": 2, "FACG": 1, "MRI": 1},
    "C":              {"IISI": 2, "IISIC": 2, "IISRT": 1, "MGE": 5, "MDI": 4, "FACG": 5, "MRI": 3},
    "L":              {"IISI": 1, "IISIC": 1, "IISRT": 1, "MGE": 3, "MDI": 4, "FACG": 2, "MRI": 4},
    "A":              {"IISI": 1, "IISIC": 1, "IISRT": 1, "MGE": 3, "MDI": 4, "FACG": 2, "MRI": 4},
    "BAC_GENERAL_FR": {"IISI": 4, "IISIC": 4, "IISRT": 4, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 3},
    "AUTRE":          {"IISI": 3, "IISIC": 3, "IISRT": 3, "MGE": 3, "MDI": 3, "FACG": 3, "MRI": 3},
}
...
CONDITIONS_ADMISSION = {
    "1ere_annee": {
        ...
        "MGE": {
            "bac_requis": ["SMA", "SMB", "SP", "SVT", "STE", "STM", "STGC", "SEG", "SGC", "LSH",
                           "S", "SM", "D", "E", "C", "L", "A", "BAC_GENERAL_FR"],
            "type_requis": ["scientifique", "technique", "economique", "gestion", "litteraire"],
            "moyenne_min": 10,
            "description": "Tous types de baccalauréat acceptés"
        },
    ...
    "3eme_annee": {
        ...
        "filieres_compatibles": {
            ...
            "IISRT": ["DUT Réseaux", "DUT Télécoms", "BTS Électronique", "Licence 2 Informatique"],
            "IISIC": ["DUT Informatique", "BTS Informatique", "Licence 2 Informatique"],
            "MGE":   ["BTS Gestion", "DUT GEA", "DEUG Économie", "Licence 2 Gestion"],
            "MDI":   ["BTS Commerce International", "DUT GEA", "DEUG Économie", "Licence 2 Gestion"],
            "FACG":  ["BTS Comptabilité", "DUT GEA", "DEUG Économie", "Licence 2 Comptabilité"],
        },
        "moyenne_min": 12,
        "procedure": "Étude de dossier + entretien"
    ...
    "4eme_annee": {
        ...
        "filieres_compatibles": {
            "IISIC": ["Licence Informatique", "BAC+3 IISI SUPMTI", "Licence Réseaux"],
            "IISRT": ["Licence Informatique", "BAC+3 IISI SUPMTI", "Licence Réseaux", "Licence Télécoms"],
            "FACG":  ["Licence Gestion", "Licence Économie", "BAC+3 MGE SUPMTI", "BAC+3 MDI SUPMTI", "Licence Comptabilité"],
            "MRI":   ["Licence Gestion", "BAC+3 MGE SUPMTI", "BAC+3 MDI SUPMTI", "Licence Économie"],
        },
        "moyenne_min": 12,
        "procedure": "Étude de dossier + entretien"
    }
...
PROFIL_PSYCHO_FILIERE = {
    "IISI": {
        "logique": 5, "creativite": 3, "leadership": 2,
        "gestion_stress": 3, "travail_equipe": 3, "style_cognitif_analytique": 5
    },
    "IISRT": {
        "logique": 5, "creativite": 2, "leadership": 2,
        "gestion_stress": 4, "travail_equipe": 3, "style_cognitif_analytique": 5
    },
    "IISIC": {
        "logique": 5, "creativite": 4, "leadership": 3,
        "gestion_stress": 3, "travail_equipe": 4, "style_cognitif_analytique": 5
    },
    "MGE": {
        "logique": 3, "creativite": 4, "leadership": 5,
        "gestion_stress": 4, "travail_equipe": 5, "style_cognitif_analytique": 3
    },
    "MDI": {
        "logique": 3, "creativite": 4, "leadership": 5,
        "gestion_stress": 4, "travail_equipe": 5, "style_cognitif_analytique": 3
    ...
    "FACG": {
        "logique": 5, "creativite": 2, "leadership": 3,
        "gestion_stress": 4, "travail_equipe": 3, "style_cognitif_analytique": 5
    },
    "MRI": {
        "logique": 3, "creativite": 4, "leadership": 5,
        "gestion_stress": 5, "travail_equipe": 5, "style_cognitif_analytique": 3
    },
}
...
INTERETS_FILIERE = {
    ...
    "MDI": [
        "international", "export", "import", "commerce international",
        "multinationale", "diplomatie", "échanges internationaux",
        "développement international", "marketing international",
        "langues étrangères", "business international"
    ],
    "FACG": [
        "finance", "comptabilité", "audit", "bourse", "investissement",
        "contrôle de gestion", "fiscalité", "chiffres", "analyse financière",
    ...
    "MRI": [
        "relations internationales", "diplomatie", "institutions internationales",
        "ong", "coopération internationale", "protocole diplomatique",
        "affaires étrangères", "ambassade", "consulat", "négociation internationale"
    ],
}
...
HISTORIQUE_ADMISSION = {
    "IISI": {
        "moyenne_admis": 12.5, "fitscore_moyen": 65, "taux_admission": 0.75,
        "profil_type": "BAC scientifique, bonne moyenne en maths"
    },
    "IISRT": {
        "moyenne_admis": 13.0, "fitscore_moyen": 68, "taux_admission": 0.70,
        "profil_type": "BAC scientifique ou technique, fort en physique"
    },
    "IISIC": {
        "moyenne_admis": 13.5, "fitscore_moyen": 72, "taux_admission": 0.65,
        "profil_type": "BAC scientifique, intérêt pour l'IA et la data"
    },
    "MGE": {
        "moyenne_admis": 11.5, "fitscore_moyen": 60, "taux_admission": 0.80,
        "profil_type": "Tout BAC, intérêt pour le commerce et la gestion"
    },
    "MDI": {
        "moyenne_admis": 11.5, "fitscore_moyen": 62, "taux_admission": 0.78,
        "profil_type": "Tout BAC, intérêt pour le commerce international"
    },
    "FACG": {
        "moyenne_admis": 13.0, "fitscore_moyen": 68, "taux_admission": 0.70,
        "profil_type": "BAC gestion ou économie, bon en maths"
    ...
    "MRI": {
        "moyenne_admis": 12.5, "fitscore_moyen": 68, "taux_admission": 0.72,
        "profil_type": "BAC+3 MGE ou MDI, attirance pour l'international"
    },
}
...
SIGNAUX_HESITATION = [
    ...
    "témoignage", "parler avec un étudiant",
    "khayef", "machi mdrass", "ma3arfch", "hésitation", "indécis"
]
